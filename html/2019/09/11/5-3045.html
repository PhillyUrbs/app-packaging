...
<html>
    <head>
        ...
        <title>IT Pro Tips for Microsoft Internet Information Server IIS SDK 5 | ITNinja</title>
        <meta name="description" content="Deployment tips, questions, blogs and other technical materials related to Microsoft Internet Information Server IIS SDK 5">
        <meta name="keywords" content="Microsoft,Microsoft Internet Information Server IIS SDK,Internet Information Server IIS SDK 5">
        ...
        <meta name="theme-color" content="#ffffff">
                <link rel="canonical" href="http://www.itninja.com/software/microsoft/internet-information-server-iis-sdk/5-3045" />
...
<nav class="navbar navbar-inverse" role="navigation" id="main-nav">
    ...
    <li><a href="/software/microsoft/internet-information-server-iis-sdk/versions">Internet Information Server IIS SDK</a></li>
    <li>5</li>
                </ul>
...
<div class="itn-content">
    ...
    <div class="content-row">
        ...
        <div id="software-version-view-meta" class="md-9">
                <h2>Microsoft Internet Information Server IIS SDK</h2>
                    ...
                    <span class="version-name" id="version-changer">
                        ...
                        <div id="version-list">
                            ...
                            <ul id="version-list-items" class="version-list">
                                                                    <li>
                                        <a
                                            href="/software/microsoft/internet-information-server-iis-sdk/5-3045"
                                            >
                                            5.x <span>(3 tips) </span>
                                        </a>
                                    </li>
                                                            </ul>
                        </div>
    ...
    <a class="btn-follow btn" rel="nofollow"
       href="/register?/follow/version/57338/JTJGc29mdHdhcmUlMkZtaWNyb3NvZnQlMkZpbnRlcm5ldC1pbmZvcm1hdGlvbi1zZXJ2ZXItaWlzLXNkayUyRjUtMzA0NQ==">
        <span> Sign up!</span>
    </a>
    or
    <a class="" rel="nofollow"
       href="/login?/follow/version/57338/JTJGc29mdHdhcmUlMkZtaWNyb3NvZnQlMkZpbnRlcm5ldC1pbmZvcm1hdGlvbi1zZXJ2ZXItaWlzLXNkayUyRjUtMzA0NQ==">
        login
    </a>
</section>
...
<div id="widget-tags" class="tags-wrap">
        ...
        <div id="software-version-view-add-version-meta-additional" class="additional-meta md-12">
            <div class="additional-meta-content callout-box">
                ...
                Internet Information Server IIS SDK has <a href="#inventory-records" id="scrollInv">1 inventory records</a>,
    ...
    <div id="deployment-tips" class="software-section">
        ...
        <div class="callout-box2">
            ...
            <ul class="nav nav-tabs" id="tips">
                    ...
                    <li class="active">
                        <a href="/software/microsoft/internet-information-server-iis-sdk/5-3045#tips">
                            All Tips
                        </a>
                    </li>
                                           <li ><a href="/software/microsoft/internet-information-server-iis-sdk/5-3045/windows#tips">
                               Windows Tips
                            </a>
                       </li>
                                    </ul>
    ...
    <div>
        ...
        <div class="tip" id="tip_4707" name="tip_4707">
...
<!--   <div class="arrow_up" id="tip-4707"></div> -->
   <div id="tip-4707" class="thumbs_up"><button class="btn btn-xs btn-link "><div class="comment-vote-up"><img src="/build/static/rating/UpArrow.svg"/></div></button></div>
    <div class="avg-rating">120</div>
   <div id="tip-4707" class="thumbs_down"><button class="btn btn-xs btn-link "><div class="comment-vote-down"><img src="/build/static/rating/DownArrow.svg"/></div></button></div>
   <!--<div class="arrow_down" id="tip-4707"></div> -->
</div>
                </div>
            </div>
...
<div class="md-11">
    <div class="the-tip">
        ...
        <div class="tip-type-heading">Note</div>
            ...
            <span id="tip-text">
            (This was based on the work of Mark Wilson)<br />
[ For v5.1 (XP) ]<br />
<br />
Using Mark's work, trial and error, and detective work, I was able to install the IIS web service that is an optional component of Windows XP *AFTER* XP is installed.<br />
<br />
**STEP-1: Make sure XP source files are available.**<br />
XP must be able to find it's setup files by itself. If you need to enter a password or something to connect to the XP source files, do so before running the CMD script.<br />
<br />
**STEP-2: Create iissetup.cmd**<br />
@echo off<br />
:: ==========================================================<br />
:: iissetup.cmd<br />
:: Windows XP Unattended Installation Script<br />
::<br />
:: Extends the base operating system build to include Internet Information<br />
:: Server, as specified in iissetup.txt<br />
::<br />
:: Based on original script Written by Mark Wilson, 13 September 2004<br />
<br />
set iisunattend=%~DP0iissetup.txt<br />
<br />
:: Call System Optional Component Manager passing iissetup.txt as a parameter<br />
C:\WINDOWS\system32\sysocmgr.exe /i:sysoc.inf /u:%iisunattend%<br />
<br />
<br />
**STEP-3: Create iissetup.TXT**<br />
; ===========================================================; iissetup.txt<br />
; Windows XP Unattended Installation Script<br />
;<br />
; Provide input to the System Optional Component Manager to install additional<br />
; operating system components, specifically All of IIS<br />
;<br />
; Based on original script Written by Mark Wilson, 13 September 2004<br />
; ===========================================================<br />
<br />
[Components]<br />
; IIS 5.1 (XP) Components to be installed <br />
;aspnet = off		;Unknown if available in XP version<br />
iss_common = on<br />
iis_ftp = on<br />
fp_extensions = on<br />
iis_inetmgr = on<br />
...
iis_smtp = on<br />
tswebclient = on<br />
;iis_webdav = off	;Unknown if available in XP version<br />
iis_www = on<br />
iis_doc = on<br />
iis_www_vdir_scripts = on<br />
iis_www_vdir_printers = on<br />
iis_www_parent = on<br />
<br />
[InternetServer]<br />
; OPTIONAL: Set the FTP and WWW server root folders - both are required to prevent the<br />
; creation of C:\Inetpub, even if set to off in [Components]<br />
;PathFTPRoot = C:\Data<br />
;PathWWWRoot = C:\Data<br />
<br />
**STEP-4: test it**<br />
-Place both files in the same folder and launch iissetup.CMD<br />
...
Jan 2006
    ...
    <div>
        ...
        <div class="tip" id="tip_4706" name="tip_4706">
...
<div id="incremental-rating" class="incrementalRating">
<!--   <div class="arrow_up" id="tip-4706"></div> -->
   <div id="tip-4706" class="thumbs_up"><button class="btn btn-xs btn-link "><div class="comment-vote-up"><img src="/build/static/rating/UpArrow.svg"/></div></button></div>
    <div class="avg-rating">119</div>
   <div id="tip-4706" class="thumbs_down"><button class="btn btn-xs btn-link "><div class="comment-vote-down"><img src="/build/static/rating/DownArrow.svg"/></div></button></div>
   <!--<div class="arrow_down" id="tip-4706"></div> -->
</div>
                </div>
            </div>
...
<div class="md-11">
    <div class="the-tip">
        ...
        <div class="tip-type-heading">Note</div>
            ...
            <span id="tip-text">
            If you need to create an unattended installation of IIS 5 follow instructions on <a href="http://support.microsoft.com/default.aspx?scid=kb;EN-US;q222444">TechNet article Q222444</a>. Create an unattended file, for example iis5.txt pasted below and run the following command inside a script:<br />
<br />
sysocmgr.exe /i:c:\winnt\inf\sysoc.inf /u:c:\winnt\IIS5.TXT<br />
<br />
Sample IIS5.TXT:<br />
<br />
[Components]<br />
;following includes 3 remmed out components<br />
iis_doc = on<br />
;iis_common = on<br />
;iis_inetmgr = on<br />
;iis_www = on<br />
;next one is debugger<br />
iisdbg = on<br />
iis_ftp = on<br />
iis_nntp = on<br />
<br />
; following is only valid for server install<br />
<br />
;iis_htmla = on<br />
iis_nntp_docs = on<br />
iis_pwmgr = on<br />
...
Source: Contributing Member, Shaun Kelly
    ...
    <div>
        ...
        <div class="tip" id="tip_4708" name="tip_4708">
...
<div id="incremental-rating" class="incrementalRating">
<!--   <div class="arrow_up" id="tip-4708"></div> -->
   <div id="tip-4708" class="thumbs_up"><button class="btn btn-xs btn-link "><div class="comment-vote-up"><img src="/build/static/rating/UpArrow.svg"/></div></button></div>
    <div class="avg-rating">117</div>
   <div id="tip-4708" class="thumbs_down"><button class="btn btn-xs btn-link "><div class="comment-vote-down"><img src="/build/static/rating/DownArrow.svg"/></div></button></div>
   <!--<div class="arrow_down" id="tip-4708"></div> -->
</div>
                </div>
            </div>
...
<div class="md-11">
    <div class="the-tip">
        ...
        <div class="tip-type-heading">Command Line</div>
            ...
            <span id="tip-text">
            Add a /q on the end to make it silent.<br />
<br />
C:\WINDOWS\system32\sysocmgr.exe /i:sysoc.inf /u:%iisunattend% /q<br />
<br />
Also, check the source path in the registry so your not prompted for files.<br />
<br />
[HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Setup]<br />
"SourcePath"=<br />
"ServicePackSourcePath"=<br />
<br />
Do not add the i386 to the end of the path.
        ...
        <div class="byline">
            <ul>
                <li>
                    <a href="/user/Nuke" class="username" rel="nofollow">Nuke</a>
                </li>
                <li>
                    12/21/2006 &nbsp;
                </li>
            ...
            <div class="inner">
                ...
                <div id="software-view-version-revision-list">
                    ...
                    <ul class="no-bullet nav nav-pills">
                                                    <li class="active">
                                <a href="/software/version/revision/57338/122685">
                                    5.2.3790.0
                                </a>
                            </li>
                                            </ul>
                ...
                <div id="software-view-version-revision-details">
                                            <h2>Internet Information Server IIS SDK</h2>
            <div><h3>Version</h3><span>5.2.3790.0</span></div>
                <div><h3>Comments</h3>To Update/Uninstall this SDK or provide feedback, click the Support Information link. To remove SDK Update components from your system if you do not have a live Internet connection, go to the root directory of the SDK Update CD and select default.htm.</div>                                                                                    
                                    </div>
                <br class="clear"/>
            </div>
    ...
    <div class="software-section" id="q-a">
        ...
        <div class="callout-box2">
            ...
            <p>Questions & Answers related to Microsoft Internet Information Server IIS SDK</p>
    ...
    <div class="software-section" id="blogs">
        ...
        <div class="callout-box2">
            ...
            <p>Blog posts related to Microsoft Internet Information Server IIS SDK</p>
    ...
    <div class="software-section" id="links">
        ...
        <div class="callout-box2">
            ...
            <p>Links related to Microsoft Internet Information Server IIS SDK</p>
    ...
    <!-- reviews -->
        <div class="software-section" id="reviews">
           ...
           <div class="callout-box2">
               ...
               <p>Reviews related to Microsoft Internet Information Server IIS SDK</p>
    ...
    <script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"65b52e7159","applicationID":"154618383","transactionName":"NQRRYkYCDUcHWxcLXgxOcENHFwxZSUsMBEUVAEFTaxUKURE=","queueTime":0,"applicationTime":208,"atts":"GUNSFA4YHkk=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
