...
<head>
    ...
    <title>IT Pro Tips for Ship Motion Associates POWERSEA 3</title>
    <meta name="description" content="Deployment tips, questions, blogs and other technical materials related to Ship Motion Associates POWERSEA 3">
    <meta name="keywords" content="Ship Motion Associates,Ship Motion Associates POWERSEA,POWERSEA 3">
    ...
    <meta name="theme-color" content="#ffffff">
            <link rel="canonical" href="http://www.itninja.com/software/ship-motion-associates/powersea/3-4119" />
...
<nav class="navbar navbar-inverse" role="navigation" id="main-nav">
    ...
    <li><a href="/software-library/company/ship-motion-associates">Ship Motion Associates</a></li>
    <li><a href="/software-library/company/ship-motion-associates/powersea">POWERSEA</a></li>
    <li>3</li>
    </ul>
...
<div class="itn-content">
    ...
    <div class="content-row">
        ...
        <div id="software-version-view-meta" class="md-9">
                <h2>Ship Motion Associates POWERSEA</h2>
                    ...
                    <span class="version-name" id="version-changer">
                        ...
                        <div id="version-list">
                            ...
                            <ul id="version-list-items" class="version-list">
                                                                    <li>
                                        <a
                                            href="/software/ship-motion-associates/powersea/3-4119"
                                            >
                                            3.x <span>(1 tips) </span>
                                        </a>
                                    </li>
                                                            </ul>
                        </div>
    ...
    <a class="btn-follow btn" rel="nofollow"
       href="/register?/follow/version/46549/JTJGc29mdHdhcmUlMkZzaGlwLW1vdGlvbi1hc3NvY2lhdGVzJTJGcG93ZXJzZWElMkYzLTQxMTk=">
        <span> Sign up!</span>
    </a>
    or
    <a class="" rel="nofollow"
       href="/login?/follow/version/46549/JTJGc29mdHdhcmUlMkZzaGlwLW1vdGlvbi1hc3NvY2lhdGVzJTJGcG93ZXJzZWElMkYzLTQxMTk=">
        login
    </a>
</section>
...
<div id="widget-tags" class="tags-wrap">
        ...
        <div id="software-version-view-add-version-meta-additional" class="additional-meta md-12">
            <div class="additional-meta-content callout-box">
                ...
                POWERSEA has <a href="#inventory-records" id="scrollInv">1 inventory records</a>,
    ...
    <div id="deployment-tips" class="software-section">
        ...
        <div class="callout-box2">
            ...
            <ul class="nav nav-tabs" id="tips">
                    ...
                    <li class="active">
                        <a href="/software/ship-motion-associates/powersea/3-4119#tips">
                            All Tips
                        </a>
                    </li>
                                           <li ><a href="/software/ship-motion-associates/powersea/3-4119/windows#tips">
                               Windows Tips
                            </a>
                       </li>
                                    </ul>
    ...
    <div>
        ...
        <div class="tip" id="tip_3568" name="tip_3568">
...
<!--   <div class="arrow_up" id="tip-3568"></div> -->
   <div id="tip-3568" class="thumbs_up"><button class="btn btn-xs btn-link "><div class="comment-vote-up"><img src="/build/static/rating/UpArrow.svg"/></div></button></div>
    <div class="avg-rating">117</div>
   <div id="tip-3568" class="thumbs_down"><button class="btn btn-xs btn-link "><div class="comment-vote-down"><img src="/build/static/rating/DownArrow.svg"/></div></button></div>
   <!--<div class="arrow_down" id="tip-3568"></div> -->
</div>
                </div>
            </div>
...
<div class="md-11">
    <div class="the-tip">
        ...
        <div class="tip-type-heading">Note</div>
            ...
            <span id="tip-text">
            <p>These notes pertain to version POWERSEA 3.2.2.10. POWERSEA uses an MSI-based installation. It supports an administrative install (msiexec /a pwrs.msi). Command-line deployment is very easy using standard msiexec commands and transforms. We created our transforms with InstallShield Tuner in AdminStudio 5.0.</p>
            </span>
        ...
        <div class="byline">
            <ul>
                <li>
                    <a href="/user/tsmiller" class="username" rel="nofollow">tsmiller</a>
                </li>
                <li>
                    06/19/2003 &nbsp;
                </li>
            ...
            <div class="inner">
                ...
                <div id="software-view-version-revision-list">
                    ...
                    <ul class="no-bullet nav nav-pills">
                                                    <li class="active">
                                <a href="/software/version/revision/46549/99957">
                                    3
                                </a>
                            </li>
                                            </ul>
                ...
                <div id="software-view-version-revision-details">
                                            <h2>POWERSEA</h2>
            <div><h3>Version</h3><span>3</span></div>
    ...
    <div class="software-section" id="q-a">
        ...
        <div class="callout-box2">
            ...
            <p>Questions & Answers related to Ship Motion Associates POWERSEA</p>
    ...
    <div class="software-section" id="blogs">
        ...
        <div class="callout-box2">
            ...
            <p>Blog posts related to Ship Motion Associates POWERSEA</p>
    ...
    <div class="software-section" id="links">
        ...
        <div class="callout-box2">
            ...
            <p>Links related to Ship Motion Associates POWERSEA</p>
    ...
    <!-- reviews -->
        <div class="software-section" id="reviews">
           ...
           <div class="callout-box2">
               ...
               <p>Reviews related to Ship Motion Associates POWERSEA</p>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam-cell.nr-data.net","licenseKey":"65b52e7159","applicationID":"154618383","transactionName":"NQRRYkYCDUcHWxcLXgxOcENHFwxZSUsMBEUVAEFTaxUKURE=","queueTime":0,"applicationTime":180,"atts":"GUNSFA4YHkk=","errorBeacon":"bam-cell.nr-data.net","agent":""}</script></body>
</html>
