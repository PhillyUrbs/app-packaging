...
<head>
    <meta charset="utf-8">
    <title>IT Pro Tips for PTC Pro-Engineer Wildfire 5</title>
    <meta name="description" content="Deployment tips, questions, blogs and other technical materials related to PTC Pro-Engineer Wildfire 5">
    <meta name="keywords" content="PTC,PTC Pro-Engineer Wildfire,Pro-Engineer Wildfire 5">
    ...
    <meta name="theme-color" content="#ffffff">
            <link rel="canonical" href="http://www.itninja.com/software/ptc/pro-engineer-wildfire/5-161" />
...
<nav class="navbar navbar-inverse" role="navigation" id="main-nav">
    ...
    <li><a href="/software-library/company/ptc">PTC</a></li>
    <li><a href="/software-library/company/ptc/pro-engineer-wildfire">Pro-Engineer Wildfire</a></li>
    <li>5</li>
    </ul>
...
<div class="itn-content">
    ...
    <div class="content-row">
        ...
        <div id="software-version-view-meta" class="md-9">
                <h2>PTC Pro-Engineer Wildfire</h2>
                    ...
                    <span class="version-name" id="version-changer">
                        ...
                        <div id="version-list">
                            ...
                            <ul id="version-list-items" class="version-list">
                                                                    <li>
                                        <a
                                            href="/software/ptc/pro-engineer-wildfire/5-161"
                                            >
                                            5.x <span>(2 tips) </span>
                                                                    ...
                                                                    <li>
                                        <a
                                            href="/software/ptc/pro-engineer-wildfire/3-218"
                                            >
                                            3.x <span>(3 tips) </span>
                                        </a>
                                    </li>
                                                                    <li>
                                        <a
                                            href="/software/ptc/pro-engineer-wildfire/2-323"
                                            >
    ...
    <a class="btn-follow btn" rel="nofollow"
       href="/register?/follow/version/2485/JTJGc29mdHdhcmUlMkZwdGMlMkZwcm8tZW5naW5lZXItd2lsZGZpcmUlMkY1LTE2MQ==">
        <span> Sign up!</span>
    </a>
    or
    <a class="" rel="nofollow"
       href="/login?/follow/version/2485/JTJGc29mdHdhcmUlMkZwdGMlMkZwcm8tZW5naW5lZXItd2lsZGZpcmUlMkY1LTE2MQ==">
        login
    </a>
</section>
...
<div id="widget-tags" class="tags-wrap">
        ...
        <div id="software-version-view-add-version-meta-additional" class="additional-meta md-12">
            <div class="additional-meta-content callout-box">
                ...
                Pro-Engineer Wildfire has <a href="#inventory-records" id="scrollInv">1 inventory records</a>,
    ...
    <div id="deployment-tips" class="software-section">
        ...
        <div class="callout-box2">
            ...
            <ul class="nav nav-tabs" id="tips">
                    ...
                    <li class="active">
                        <a href="/software/ptc/pro-engineer-wildfire/5-161#tips">
                            All Tips
                        </a>
                    </li>
                                           <li ><a href="/software/ptc/pro-engineer-wildfire/5-161/windows#tips">
                               Windows Tips
                            </a>
                       </li>
                                    </ul>
    ...
    <div>
        ...
        <div class="tip" id="tip_290" name="tip_290">
...
<!--   <div class="arrow_up" id="tip-290"></div> -->
   <div id="tip-290" class="thumbs_up"><button class="btn btn-xs btn-link "><div class="comment-vote-up"><img src="/build/static/rating/UpArrow.svg"/></div></button></div>
    <div class="avg-rating">5</div>
   <div id="tip-290" class="thumbs_down"><button class="btn btn-xs btn-link "><div class="comment-vote-down"><img src="/build/static/rating/DownArrow.svg"/></div></button></div>
   <!--<div class="arrow_down" id="tip-290"></div> -->
</div>
                </div>
            </div>
...
<div class="md-11">
    <div class="the-tip">
        ...
        <div class="tip-type-heading">Command Line</div>
            ...
            <span id="tip-text">
            1) For Silent Install:<br />
      a) You can record your menu selections in the PTC.Setup installation utility in a trail file to replay them at a later time: &lt;dir&gt;\setup.exe -uilog<br />
      b) To replay the PTC.Setup trail file, you must first rename the trail file using the &lt;filename&gt;.txt naming convention. For example, rename the pc_trl.txt.1 file to install.txt. To replay the trail file, use this new file name with the -uitrail argument at the command prompt:<br />
&lt;dir&gt;\setup.exe -uitrail install.txt<br />
<br />
2) For Silent Uninstall:<br />
You can create and use the PTC.Setup trail file to uninstall Pro/ENGINEER. Create the PTC.Setup trail file as follows:<br />
&lt;loadpoint&gt;\uninstall\i486_nt\obj\psuninst.exe &lt;loadpoint&gt;\uninstall\instlog.txt -uilog<br />
Use the trail file to uninstall Pro/ENGINEER as follows:<br />
&lt;loadpoint&gt;\uninstall\i486_nt\obj\psuninst.exe -uitrail mytrail.txt &lt;loadpoint&gt;\uninstall\instlog.txt
            </span>
        ...
        <div class="byline">
            <ul>
                <li>
                    <a href="/user/ahmedrab26" class="username" rel="nofollow">ahmedrab26</a>
                </li>
                <li>
                    04/26/2011 &nbsp;
                </li>
    ...
    <div>
        ...
        <div class="tip" id="tip_291" name="tip_291">
...
<div id="incremental-rating" class="incrementalRating">
<!--   <div class="arrow_up" id="tip-291"></div> -->
   <div id="tip-291" class="thumbs_up"><button class="btn btn-xs btn-link "><div class="comment-vote-up"><img src="/build/static/rating/UpArrow.svg"/></div></button></div>
    <div class="avg-rating">3</div>
   <div id="tip-291" class="thumbs_down"><button class="btn btn-xs btn-link "><div class="comment-vote-down"><img src="/build/static/rating/DownArrow.svg"/></div></button></div>
   <!--<div class="arrow_down" id="tip-291"></div> -->
</div>
                </div>
            </div>
...
<div class="md-11">
    <div class="the-tip">
        ...
        <div class="tip-type-heading">Command Line</div>
            ...
            <span id="tip-text">
            <p>There is a way to do a silent uninstall - run [source]uninstall\i486_nt\obj\psininst.exe [source]\uninstall\instlog.txt (or wherever you have the existing instlog.txt) -uilog.  That will creat a uninstall_trl.txt.1 file in your home directory.  Rename the file to .txt then you can run the same command as above -uitrail [path]\uilog.txt and have a silent uninstall</p>
            </span>
            <div class="setup-wrap">
        ...
        <div class="byline">
            <ul>
                <li>
                    <a href="/user/Arminius" class="username" rel="nofollow">Arminius</a>
                </li>
                <li>
                    09/01/2011 &nbsp;
                </li>
            ...
            <div class="inner">
                ...
                <div id="software-view-version-revision-list">
                    ...
                    <ul class="no-bullet nav nav-pills">
                                                    <li class="active">
                                <a href="/software/version/revision/2485/4960">
                                    5
                                </a>
                            </li>
                                            </ul>
                ...
                <div id="software-view-version-revision-details">
                                            <h2>Pro-Engineer Wildfire</h2>
            <div><h3>Version</h3><span>5</span></div>
    ...
    <div class="software-section" id="q-a">
        ...
        <div class="callout-box2">
            ...
            <p>Questions & Answers related to PTC Pro-Engineer Wildfire</p>
    ...
    <div class="content-meta">
        ...
        <a href="/question/pro-e-wildfire-5-network-install" class="title">
            Pro/E Wildfire 5 Network Install
        </a>
     ...
     >
            ...
            <div class="byline">
                By:
                <a href="/user/lgeier" rel="nofollow">lgeier</a>
...
<!--end question -->                
    ...
    <div class="software-section" id="blogs">
        ...
        <div class="callout-box2">
            ...
            <p>Blog posts related to PTC Pro-Engineer Wildfire</p>
    ...
    <div class="software-section" id="links">
        ...
        <div class="callout-box2">
            ...
            <p>Links related to PTC Pro-Engineer Wildfire</p>
    ...
    <!-- reviews -->
        <div class="software-section" id="reviews">
           ...
           <div class="callout-box2">
               ...
               <p>Reviews related to PTC Pro-Engineer Wildfire</p>
