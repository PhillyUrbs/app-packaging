...
<head>
    <meta charset="utf-8">
    <title>IT Pro Tips for Microsoft Microsoft Data Engine (MSDE) 6</title>
    <meta name="description" content="Deployment tips, questions, blogs and other technical materials related to Microsoft Microsoft Data Engine (MSDE) 6">
    <meta name="keywords" content="Microsoft,Microsoft Microsoft Data Engine (MSDE),Microsoft Data Engine (MSDE) 6">
    ...
    <meta name="theme-color" content="#ffffff">
            <link rel="canonical" href="http://www.itninja.com/software/microsoft/microsoft-data-engine-msde/6-1330" />
...
<nav class="navbar navbar-inverse" role="navigation" id="main-nav">
    ...
    <li><a href="/software-library/company/microsoft/microsoft-data-engine-msde">Microsoft Data Engine (MSDE)</a></li>
    <li>6</li>
    </ul>
...
<div class="itn-content">
    ...
    <div class="content-row">
        ...
        <div id="software-version-view-meta" class="md-9">
                <h2>Microsoft Microsoft Data Engine (MSDE)</h2>
                    ...
                    <span class="version-name" id="version-changer">
                        ...
                        <div id="version-list">
                            ...
                            <ul id="version-list-items" class="version-list">
                                                                    <li>
                                        <a
                                            href="/software/microsoft/microsoft-data-engine-msde/6-1330"
                                            >
                                            6.x <span>(2 tips) </span>
                                        </a>
                                    </li>
                                                            </ul>
                        </div>
    ...
    <a class="btn-follow btn" rel="nofollow"
       href="/register?/follow/version/25786/JTJGc29mdHdhcmUlMkZtaWNyb3NvZnQlMkZtaWNyb3NvZnQtZGF0YS1lbmdpbmUtbXNkZSUyRjYtMTMzMA==">
        <span> Sign up!</span>
    </a>
    or
    <a class="" rel="nofollow"
       href="/login?/follow/version/25786/JTJGc29mdHdhcmUlMkZtaWNyb3NvZnQlMkZtaWNyb3NvZnQtZGF0YS1lbmdpbmUtbXNkZSUyRjYtMTMzMA==">
        login
    </a>
</section>
...
<div id="widget-tags" class="tags-wrap">
        ...
        <div id="software-version-view-add-version-meta-additional" class="additional-meta md-12">
            <div class="additional-meta-content callout-box">
                ...
                Microsoft Data Engine (MSDE) has <a href="#inventory-records" id="scrollInv">1 inventory records</a>,
    ...
    <div id="deployment-tips" class="software-section">
        ...
        <div class="callout-box2">
            ...
            <ul class="nav nav-tabs" id="tips">
                    ...
                    <li class="active">
                        <a href="/software/microsoft/microsoft-data-engine-msde/6-1330#tips">
                            All Tips
                        </a>
                    </li>
                                           <li ><a href="/software/microsoft/microsoft-data-engine-msde/6-1330/windows#tips">
                               Windows Tips
                            </a>
                       </li>
                                    </ul>
    ...
    <div>
        ...
        <div class="tip" id="tip_2167" name="tip_2167">
...
<!--   <div class="arrow_up" id="tip-2167"></div> -->
   <div id="tip-2167" class="thumbs_up"><button class="btn btn-xs btn-link "><div class="comment-vote-up"><img src="/build/static/rating/UpArrow.svg"/></div></button></div>
    <div class="avg-rating">117</div>
   <div id="tip-2167" class="thumbs_down"><button class="btn btn-xs btn-link "><div class="comment-vote-down"><img src="/build/static/rating/DownArrow.svg"/></div></button></div>
   <!--<div class="arrow_down" id="tip-2167"></div> -->
</div>
                </div>
            </div>
...
<div class="md-11">
    <div class="the-tip">
        ...
        <div class="tip-type-heading">Command Line</div>
            ...
            <span id="tip-text">
            The following syntax is used to install MSDE using all of the default installation settings:<br />
<br />
MSDEx86.exe -s -a -f1 "&lt;path&gt;unattend.iss"<br />
<br />
or<br />
<br />
MSDEalpha.exe -s -a -f1 "&lt;path&gt;unattend.iss"<br />
<br />
&lt;path&gt; should represent the full path to the unattend.iss file. You must always indicate the fully qualified path to the .iss file. See below for sample iss file.<br />
<br />
To use installation settings other than the defaults, a copy of the unattend.iss file can be edited and passed on the command line. For example, assuming that a copy of unattend.iss is copied to c:\temp, renamed to "mydefaults.iss" and edited. It would be possible to install MSDE using this new .iss file by issuing the following command:<br />
<br />
msdex86.exe -s -a -f1 "c:\temp\mydefaults.iss"
    ...
    <div>
        ...
        <div class="tip" id="tip_2168" name="tip_2168">
...
<div id="incremental-rating" class="incrementalRating">
<!--   <div class="arrow_up" id="tip-2168"></div> -->
   <div id="tip-2168" class="thumbs_up"><button class="btn btn-xs btn-link "><div class="comment-vote-up"><img src="/build/static/rating/UpArrow.svg"/></div></button></div>
    <div class="avg-rating">117</div>
   <div id="tip-2168" class="thumbs_down"><button class="btn btn-xs btn-link "><div class="comment-vote-down"><img src="/build/static/rating/DownArrow.svg"/></div></button></div>
   <!--<div class="arrow_down" id="tip-2168"></div> -->
</div>
                </div>
            </div>
...
<div class="md-11">
    <div class="the-tip">
        ...
        <div class="tip-type-heading">Command Line</div>
            ...
            <span id="tip-text">
            &lt;block&gt;[InstallShield Silent]<br />
Version=v5.00.000<br />
File=Response File<br />
[DlgOrder]<br />
Dlg0=SetupMethod-0<br />
Count=10<br />
Dlg1=SdWelcome-0<br />
Dlg2=SdLicense-0<br />
Dlg3=SdRegisterUser-0<br />
Dlg4=SetupTypeSQL-0<br />
Dlg5=DlgCpSortUnicode-0<br />
Dlg6=DlgServerNetwork-0<br />
Dlg7=DlgServices-0<br />
Dlg8=SdStartCopy-0<br />
Dlg9=SdFinish-0<br />
[SetupMethod-0]<br />
Component-type=string<br />
Component-count=1<br />
Component-0=Local<br />
Result=1<br />
[SdWelcome-0]<br />
Result=1<br />
[SdLicense-0]<br />
...
szDir=C:\MSSQL7<br />
Result=302<br />
szDataDir=C:\MSSQL7<br />
[DlgCpSortUnicode-0]<br />
SortId=52<br />
LCID=1033<br />
CompStyle=196609<br />
Result=1<br />
[DlgServerNetwork-0]<br />
NetworkLibs=4095<br />
TCPPort=1433<br />
TCPPrxy=Default<br />
NMPPipeName=\\.\pipe\sql\query<br />
Result=1<br />
[DlgServices-0]<br />
Local-Domain=3855<br />
;AutoStart=61455<br />
AutoStart=0<br />
Result=1<br />
[SdStartCopy-0]<br />
...
&lt;/block&gt;
            ...
            <div class="inner">
                ...
                <div id="software-view-version-revision-list">
                    ...
                    <ul class="no-bullet nav nav-pills">
                                                    <li class="active">
                                <a href="/software/version/revision/25786/53514">
                                    6
                                </a>
                            </li>
                                            </ul>
                ...
                <div id="software-view-version-revision-details">
                                            <h2>Microsoft Data Engine (MSDE)</h2>
            <div><h3>Version</h3><span>6</span></div>
    ...
    <div class="software-section" id="q-a">
        ...
        <div class="callout-box2">
            ...
            <p>Questions & Answers related to Microsoft Microsoft Data Engine (MSDE)</p>
    ...
    <div class="content-meta">
        ...
        <a href="/question/i-was-wondering-if-anyone-has-tried-successfully-to-deploy-visual-studio-2012-without-including-sql-express" class="title">
            I was wondering if anyone has tried successfully to deploy Visual Studio 2012 without including SQL Express
        </a>
     ...
     >
            ...
            <div class="byline">
                By:
                <a href="/user/strebortap" rel="nofollow">strebortap</a>
...
<!--end question -->                
    ...
    <div class="software-section" id="blogs">
        ...
        <div class="callout-box2">
            ...
            <p>Blog posts related to Microsoft Microsoft Data Engine (MSDE)</p>
    ...
    <div class="software-section" id="links">
        ...
        <div class="callout-box2">
            ...
            <p>Links related to Microsoft Microsoft Data Engine (MSDE)</p>
    ...
    <div class="content-meta">
            ...
            <a href="/link/microsoft-msde-home" class="title">
                Microsoft MSDE Home
            </a>
    ...
    <!-- reviews -->
        <div class="software-section" id="reviews">
           ...
           <div class="callout-box2">
               ...
               <p>Reviews related to Microsoft Microsoft Data Engine (MSDE)</p>
