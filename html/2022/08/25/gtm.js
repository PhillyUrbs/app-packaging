...
<head>
    <meta charset="utf-8">
    <title>IT Pro Tips for Minitab Bootstrapper 1</title>
    <meta name="description" content="Deployment tips, questions, blogs and other technical materials related to Minitab Bootstrapper 1">
    <meta name="keywords" content="Minitab,Minitab Bootstrapper,Bootstrapper 1">
    ...
    <meta name="theme-color" content="#ffffff">
            <link rel="canonical" href="http://www.itninja.com/software/minitab/bootstrapper/1-3223" />
...
<nav class="navbar navbar-inverse" role="navigation" id="main-nav">
    ...
    <li><a href="/software-library/company/minitab">Minitab</a></li>
    <li><a href="/software-library/company/minitab/bootstrapper">Bootstrapper</a></li>
    <li>1</li>
    </ul>
...
<div class="itn-content">
                    ...
                    <span class="version-name" id="version-changer">
                        ...
                        <div id="version-list">
                            ...
                            <ul id="version-list-items" class="version-list">
                                                                    <li>
                                        <a
                                            href="/software/minitab/bootstrapper/1-3223"
                                            >
    ...
    <a class="btn-follow btn" rel="nofollow"
       href="/register?/follow/version/12346/JTJGc29mdHdhcmUlMkZtaW5pdGFiJTJGYm9vdHN0cmFwcGVyJTJGMS0zMjIz">
        <span> Sign up!</span>
    </a>
    or
    <a class="" rel="nofollow"
       href="/login?/follow/version/12346/JTJGc29mdHdhcmUlMkZtaW5pdGFiJTJGYm9vdHN0cmFwcGVyJTJGMS0zMjIz">
        login
    </a>
</section>
...
<div id="widget-tags" class="tags-wrap">
        ...
        <div id="software-version-view-add-version-meta-additional" class="additional-meta md-12">
            <div class="additional-meta-content callout-box">
                ...
                Bootstrapper has <a href="#inventory-records" id="scrollInv">2 inventory records</a>,
    ...
    <div id="deployment-tips" class="software-section">
        ...
        <div class="callout-box2">
            ...
            <ul class="nav nav-tabs" id="tips">
                    ...
                    <li class="active">
                        <a href="/software/minitab/bootstrapper/1-3223#tips">
                            All Tips
                        </a>
                    </li>
                                           <li ><a href="/software/minitab/bootstrapper/1-3223/windows#tips">
                               Windows Tips
                            </a>
                       </li>
                                    </ul>
            ...
            <div class="inner">
                ...
                <div id="software-view-version-revision-list">
                    ...
                    <ul class="no-bullet nav nav-pills">
                                                    <li class="active">
                                <a href="/software/version/revision/12346/25610">
                                    1.0.0.0
                                </a>
                            </li>
                                                    <li >
                                <a href="/software/version/revision/12346/25611">
                                    1.1.0.0
                                </a>
                            </li>
                                            </ul>
                ...
                <div id="software-view-version-revision-details">
                                            <h2>Bootstrapper</h2>
            <div><h3>Version</h3><span>1.0.0.0</span></div>
                                                        <div><h3>Uninstall String</h3>MsiExec.exe /I{EFDD0584-E443-4CA8-8B79-E5BE7B22651D}</div>                                            
                                    </div>
                <br class="clear"/>
            </div>
    ...
    <div class="software-section" id="q-a">
        ...
        <div class="callout-box2">
            ...
            <p>Questions & Answers related to Minitab Bootstrapper</p>
    ...
    <div class="software-section" id="blogs">
        ...
        <div class="callout-box2">
            ...
            <p>Blog posts related to Minitab Bootstrapper</p>
    ...
    <div class="software-section" id="links">
        ...
        <div class="callout-box2">
            ...
            <p>Links related to Minitab Bootstrapper</p>
    ...
    <!-- reviews -->
        <div class="software-section" id="reviews">
           ...
           <div class="callout-box2">
               ...
               <p>Reviews related to Minitab Bootstrapper</p>
