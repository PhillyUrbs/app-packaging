...
<head>
    <meta charset="utf-8">
    <title>IT Pro Tips for Hummingbird Exceed 2008 13</title>
    <meta name="description" content="Deployment tips, questions, blogs and other technical materials related to Hummingbird Exceed 2008 13">
    <meta name="keywords" content="Hummingbird,Hummingbird Exceed 2008,Exceed 2008 13">
    ...
    <meta name="theme-color" content="#ffffff">
            <link rel="canonical" href="http://www.itninja.com/software/hummingbird/exceed-2008/13-52" />
...
<nav class="navbar navbar-inverse" role="navigation" id="main-nav">
    ...
    <li><a href="/software-library/company/hummingbird">Hummingbird</a></li>
    <li><a href="/software-library/company/hummingbird/exceed-2008">Exceed 2008</a></li>
    <li>13</li>
    </ul>
...
<div class="itn-content">
                    ...
                    <span class="version-name" id="version-changer">
                        ...
                        <div id="version-list">
                            ...
                            <ul id="version-list-items" class="version-list">
                                                                    <li>
                                        <a
                                            href="/software/hummingbird/exceed-2008/13-52"
                                            >
    ...
    <a class="btn-follow btn" rel="nofollow"
       href="/register?/follow/version/9479/JTJGc29mdHdhcmUlMkZodW1taW5nYmlyZCUyRmV4Y2VlZC0yMDA4JTJGMTMtNTI=">
        <span> Sign up!</span>
    </a>
    or
    <a class="" rel="nofollow"
       href="/login?/follow/version/9479/JTJGc29mdHdhcmUlMkZodW1taW5nYmlyZCUyRmV4Y2VlZC0yMDA4JTJGMTMtNTI=">
        login
    </a>
</section>
...
<div id="widget-tags" class="tags-wrap">
        ...
        <div id="software-version-view-add-version-meta-additional" class="additional-meta md-12">
            <div class="additional-meta-content callout-box">
                ...
                Exceed 2008 has <a href="#inventory-records" id="scrollInv">1 inventory records</a>,
    ...
    <div id="deployment-tips" class="software-section">
        ...
        <div class="callout-box2">
            ...
            <ul class="nav nav-tabs" id="tips">
                    ...
                    <li class="active">
                        <a href="/software/hummingbird/exceed-2008/13-52#tips">
                            All Tips
                        </a>
                    </li>
                                           <li ><a href="/software/hummingbird/exceed-2008/13-52/windows#tips">
                               Windows Tips
                            </a>
                       </li>
                                    </ul>
    ...
    <div>
        ...
        <div class="tip" id="tip_904" name="tip_904">
...
<!--   <div class="arrow_up" id="tip-904"></div> -->
   <div id="tip-904" class="thumbs_up"><button class="btn btn-xs btn-link "><div class="comment-vote-up"><img src="/build/static/rating/UpArrow.svg"/></div></button></div>
    <div class="avg-rating">1</div>
   <div id="tip-904" class="thumbs_down"><button class="btn btn-xs btn-link "><div class="comment-vote-down"><img src="/build/static/rating/DownArrow.svg"/></div></button></div>
   <!--<div class="arrow_down" id="tip-904"></div> -->
</div>
                </div>
            </div>
...
<div class="md-11">
    <div class="the-tip">
        ...
        <div class="tip-type-heading">Command Line</div>
            ...
            <span id="tip-text">
            A full silent install with status:<br />
msiexec /i "Exceed 2008.msi" /qb-! /norestart<br />
<br />
Obvious but it works!
        ...
        <div class="byline">
            <ul>
                <li>
                    <a href="/user/andylaurence" class="username" rel="nofollow">andylaurence</a>
                </li>
                <li>
                    07/08/2009 &nbsp;
                </li>
        ...
        <div class="comment-wrap">
            <div >
                                <div class="the-comment">Thanks! -
                    <a class="username" href="/user/jriekse5555" rel="nofollow">jriekse5555</a>
    ...
    <div>
        ...
        <div class="tip" id="tip_903" name="tip_903">
...
<div id="incremental-rating" class="incrementalRating">
<!--   <div class="arrow_up" id="tip-903"></div> -->
   <div id="tip-903" class="thumbs_up"><button class="btn btn-xs btn-link "><div class="comment-vote-up"><img src="/build/static/rating/UpArrow.svg"/></div></button></div>
    <div class="avg-rating">0</div>
   <div id="tip-903" class="thumbs_down"><button class="btn btn-xs btn-link "><div class="comment-vote-down"><img src="/build/static/rating/DownArrow.svg"/></div></button></div>
   <!--<div class="arrow_down" id="tip-903"></div> -->
</div>
                </div>
            </div>
...
<div class="md-11">
    <div class="the-tip">
        ...
        <div class="tip-type-heading">Note</div>
            ...
            <span id="tip-text">
            In order to configure communication start-up launch Xconfig shortcut by browsing to it from your Start menu Hummingbird Connectivity 2008 -&gt; Exceed Tools -&gt;Xconfig. Any changes you make hear will modify Exceed.xcfg which is saved under %APPDATA%\Hummingbird\Connectivity\13.00\Exceed.<br />
Make the file part of your installation (in the MST) or copy it after the installation is finished. These way users do not have to configure the communications themselves<br />
        ...
        <div class="byline">
            <ul>
                <li>
                    <a href="/user/jawch" class="username" rel="nofollow">jawch</a>
                </li>
                <li>
                    07/08/2009 &nbsp;
                </li>
            ...
            <div class="inner">
                ...
                <div id="software-view-version-revision-list">
                    ...
                    <ul class="no-bullet nav nav-pills">
                                                    <li class="active">
                                <a href="/software/version/revision/9479/19501">
                                    13
                                </a>
                            </li>
                                            </ul>
                ...
                <div id="software-view-version-revision-details">
                                            <h2>Exceed 2008</h2>
            <div><h3>Version</h3><span>13</span></div>
    ...
    <div class="software-section" id="q-a">
        ...
        <div class="callout-box2">
            ...
            <p>Questions & Answers related to Hummingbird Exceed 2008</p>
    ...
    <div class="software-section" id="blogs">
        ...
        <div class="callout-box2">
            ...
            <p>Blog posts related to Hummingbird Exceed 2008</p>
    ...
    <div class="software-section" id="links">
        ...
        <div class="callout-box2">
            ...
            <p>Links related to Hummingbird Exceed 2008</p>
    ...
    <!-- reviews -->
        <div class="software-section" id="reviews">
           ...
           <div class="callout-box2">
               ...
               <p>Reviews related to Hummingbird Exceed 2008</p>
